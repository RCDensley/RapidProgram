...
export default function Dashboard() {
  ...
  // For fixed-price SOWs: internal view uses timesheet/allocation calc; client view uses milestone calc
  const isFixedSelectedSow = selectedSow?.pricingType === 'fixed'
  const useInternalCalc    = isFixedSelectedSow && burndownView === 'internal'
  const sowActual   = selectedSow ? sowActualCost(selectedSow.id, data, true, useInternalCalc) : 0
