...
export function getProgramSummary(data: AppData): ProgramSummary {
  ...
  // KPI matches the per-SOW cards: pricing-type-aware (milestone totals for fixed-price SOWs).
  // The burndown chart is separately forced to allocation-based to keep its lines smooth — the
  // chart represents internal spend forecast, KPI represents the client-facing commitment.
